...
@str_literal.92 = internal global <{ i32, i32, [85 x i8] }> <{ i32 -1000000000, i32 85, [85 x i8] c"kynatorctl -- offline orchestrator control-plane tool (operates on a config backup dump)" }>
